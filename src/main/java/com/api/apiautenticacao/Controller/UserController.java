...
public class UserController {
    ...
    public ResponseEntity<ResponseUserDTO> recuperarSenha(@RequestBody String email, String password) {
        // Lógica para recuperar a senha do usuário com base no email
        ResponseUserDTO loginDTO = userServices.updatePassword(email, password);
